...
function startGame(){
  gameStatus="start";
  document.getElementById("status").innerHTML="Creating Game, get ready for some fun!"
}
function game(){
...
function jumping(character){
	if( (ny<175&&character.live) || (touchIsDown&&character.live) ){
